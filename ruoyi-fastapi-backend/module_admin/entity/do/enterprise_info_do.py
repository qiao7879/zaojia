...
class Enterprise(Base):
    ...
    ent_type = Column(BigInteger, nullable=False, server_default='1', comment='企业类型')
    address = Column(
        String(500),
        nullable=True,
        # 复用你原有代码中的空值默认值设置方式
    ...
    contact_person = Column(String(50), nullable=True, server_default=None, comment='联系人')
    contact_phone = Column(String(20), nullable=True, server_default=None, comment='联系电话')
    bank_name = Column(String(100), nullable=True, server_default=None, comment='开户行')
    bank_account = Column(String(30), nullable=True, server_default=None, comment='银行账号')
